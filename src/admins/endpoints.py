...
from .schemas import SectionSchemaCreate, SectionSchemaReturn, Kek
from .crud import create, get_list, get_object, delete_object
...
async def update_put_section():
    pass

async def update_patch_section():
    pass
